# QuantForge v23.80 — Comprehensive Build Summary

## Release
- v23.80: Multi Objective Pareto Analysis
- Build is cumulative from v23.70 and preserves the hard live-brokerage lock.

## New capability
- Multi Objective Pareto Analysis added as a governed, simulation/research-only subsystem.
...
## Source inventory
- C# source files under src: 203
- Total C# files including architecture checks: 276
