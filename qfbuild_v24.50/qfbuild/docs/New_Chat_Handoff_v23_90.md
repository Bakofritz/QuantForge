# QuantForge v23.90 — New-Chat Handoff

Continue the QuantForge Master Build from v23.90 using this package as the cumulative source baseline.
...
- Risk Exposure Correlation Scenario Analysis.
