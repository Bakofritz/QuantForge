# QuantForge v24.05 — Comprehensive Build Summary

## Release
- v24.05: Deterministic Replay Certification
- Build is cumulative from v23.70 and preserves the hard live-brokerage lock.

## New capability
- Deterministic Replay Certification added as a governed, simulation/research-only subsystem.
...
## Source inventory
- C# source files under src: 208
- Total C# files including architecture checks: 286
