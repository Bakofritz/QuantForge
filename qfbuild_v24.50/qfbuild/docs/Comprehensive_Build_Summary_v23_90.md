# QuantForge v23.90 — Comprehensive Build Summary

## Release
- v23.90: Risk Exposure Correlation Scenario Analysis
- Build is cumulative from v23.70 and preserves the hard live-brokerage lock.

## New capability
- Risk Exposure Correlation Scenario Analysis added as a governed, simulation/research-only subsystem.
...
## Source inventory
- C# source files under src: 205
- Total C# files including architecture checks: 280
