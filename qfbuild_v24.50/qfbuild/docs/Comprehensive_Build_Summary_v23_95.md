# QuantForge v23.95 — Comprehensive Build Summary

## Release
- v23.95: Research Provenance Reproducibility
- Build is cumulative from v23.70 and preserves the hard live-brokerage lock.

## New capability
- Research Provenance Reproducibility added as a governed, simulation/research-only subsystem.
...
## Source inventory
- C# source files under src: 206
- Total C# files including architecture checks: 282
